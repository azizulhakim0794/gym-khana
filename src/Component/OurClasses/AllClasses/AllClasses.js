        ...
        <div>
            ...
            <div className="container ">
                ...
                <div className="top-margin row">
                    ...
                    <div className="col-md-6 col-sm-6 col-6 row">
                        ...
                        <div className="d-flex justify-content-center mt-4">
                            ...
                            <div className="col-md-6 ms-5">
                                <div>
                                    <h3>Monday</h3>
                                    <p className="text-warning">6:AM - 10:AM</p>
                                </div>
                                <br />
                                <br />
                                <div>
                                    <h3>Saturday</h3>
                                    <p className="text-warning">11:AM - 3:PM</p>
                                </div>
                                <br />
                                <br />
                                <div>
                                    <h3>Wednesday</h3>
                                    <p className="text-warning">8:AM - 12:PM</p>
                                </div>
                            </div>
                            <div className="col-md-6 ms-3">
                                <div>
                                    <h3>Sunday</h3>
                                    <p className="text-warning">9:AM - 12:PM</p>
                                </div>
                                <br />
                                <br />
                                <div>
                                    <h3>Tuesday</h3>
                                    <p className="text-warning">7:AM - 11:AM</p>
                                </div>
                                <br />
                                <br />
                                <div>
                                    <h3>Thursday</h3>
                                    <p className="text-warning">10:AM - 1:AM</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="">
                   ...
                   <div className="d-flex justify-content-end mr-5">
                       <button className="btn-gym btn-warning" onClick={handlePricePlan}>JOIN US</button>
                   </div>
            </div>
            <HomeFooter />
        </div>
